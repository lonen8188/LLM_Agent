# 파이단틱의 BaseModel로 출력 형태 정의하기
# 불필요한 문장까지 출력되는 문제를 개선하기 위해 08-3절에서 파이단틱Pydantic의 BaseModel을 활용했습니다. 
# 여기서도 supervisor_chain의 출력을 파이단틱 BaseModel을 활용한 클래스로 만들어 보겠습니다. 
# 이렇게 하면 우리가 원하는 형태로 'content_strategist'나 'communicator'처럼 지정된 표현만 반환할 수 있습니다.

# 새로운 파일 models.py를 만들고 다음처럼 Task 모델을 생성하는 코드를 작성합니다.
